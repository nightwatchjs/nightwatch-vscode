/**
 * this module contains functions to show Nightwatch test results in
 * vscode inspector via the DiagnosticsCollection.
 */
import * as vscode from 'vscode';
import { existsSync } from 'fs';
import { TestReconciliationState } from './TestResults/matchByContext';
...
// update all diagnosis with Nightwatch test results
